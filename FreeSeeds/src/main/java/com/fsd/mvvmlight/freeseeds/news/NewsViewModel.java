package com.fsd.mvvmlight.freeseeds.news;
...
/**
 * Created by Duke on 17-3-25.
 */
public class NewsViewModel implements ViewModel {
    public static final String TOKEN_TOP_NEWS_FINISH = "token_top_news_finish" + FreeSeedsApp.sPackageName;
